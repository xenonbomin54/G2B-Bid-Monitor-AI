...
_중소기업 = _p(r"중소기업", r"중·소기업", r"중,\s?소기업", r"중・소기업")

# ⚠️ '소기업' 은 '중소기업기본법' 의 부분문자열이다. 방어하지 않으면
#    중소기업을 언급한 모든 공고가 '소기업 제한 있음'으로 잡힌다.
#    dev 200건에서 (중소제한, 소기업제한)=(True,True) 가 107건이었고,
#    그 결과 v18(소기업 제한 없음이 위반)의 진짜 양성이 규칙에 의해 억제됐다.
_소기업 = _p(
    r"(?<!중)(?<!중·)(?<!중,)(?<!중・)(?<!중 )소기업",
    r"소상공인", r"벤처기업", r"창업기업",
)
